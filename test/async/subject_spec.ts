...
describe('Subject', () => {
  ...
  it('should listen for complete notifications and '
        + 'unsubscribe from its subscriptions',
     done => {
       let subject: Subject<void> = new Subject<void>();
       let observable: Observable<void> = Observable.create<void>(observer => {
         observer.complete();
       });
       subject.subscribeTo(observable);
       subject.subscribeOnComplete(() => {
